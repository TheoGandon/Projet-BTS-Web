...
export default function ProfileCard({userData, onUpdate, setIsUpdated}) {
            ...
            <Card className="w-2/3 md:w-1/2 lg:w-1/3 bg-white rounded-lg border border-gray-200 shadow-md">
                <CardContent className="border-t border-gray-200">
                    ...
                    <div className="flex flex-col p-5 space-y-3">
                        ...
                        {updateSuccess && <p style={{ color: 'green' }}>Mise à jour réussie!</p>} {/* Afficher un message en vert si la mise à jour a réussi */}
                        <Button variant="contained" className='w-full' onClick={handleUpdate}
                                style={{...styles.submit, ...styles.blackButton}}>Update</Button>
                        <Button variant="contained" className='w-full' onClick={handleProfile}
                                style={{...styles.submit, ...styles.blackButton}}>Voir Profile</Button>
